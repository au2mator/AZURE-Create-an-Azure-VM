...
# Type: New Service
#
# Title: AZURE - Create an Azure VM
#
...
# 
#
# Init Release: 19.08.2021
# Last Update: 19.08.2021
# Code Template V 1.4
#
# URL: https://au2mator.com/create-an-azure-vm-azure-self-service-with-au2mator/?utm_source=github&utm_medium=social&utm_campaign=AZURE_CreateVM&utm_content=PS1
# Github: https://github.com/au2mator/AZURE-Create-an-Azure-VM
#
...
[string]$LogPath = "C:\_SCOworkingDir\TFS\PS-Services\AZURE - Create an Azure VM"
[string]$LogfileName = "AZURE - Create an Azure VM"
...
$subscriptionId = '5e51180c-fde0-46ae-974d-9d8f2e198e4b'
...
Function GET-VMImage {
    ...
    $data = @(
        [pscustomobject]@{NiceName = 'Windows Server 2019 Datacenter'; publisher  = 'MicrosoftWindowsServer' ; offer  = 'WindowsServer' ; sku  = '2019-Datacenter' }
        [pscustomobject]@{NiceName = 'Windows Server 2022 Datacenter'; publisher  = 'MicrosoftWindowsServer' ; offer  = 'WindowsServer' ; sku  = '2022-datacenter' }
        [pscustomobject]@{NiceName = 'Windows Server 2019 Datacenter-Core'; publisher  = 'MicrosoftWindowsServer' ; offer  = 'WindowsServer' ; sku  = '2019-Datacenter-Core' }
        [pscustomobject]@{NiceName = 'Windows Server 2022 Datacenter-Core'; publisher  = 'MicrosoftWindowsServer' ; offer  = 'WindowsServer' ; sku  = '2022-datacenter-Core' }
        [pscustomobject]@{NiceName = 'Windows Server 2016 Datacenter-Core'; publisher  = 'MicrosoftWindowsServer' ; offer  = 'WindowsServer' ; sku  = '2016-Datacenter-Core' }
        [pscustomobject]@{NiceName = 'Windows Server 2016 Datacenter'; publisher  = 'MicrosoftWindowsServer' ; offer  = 'WindowsServer' ; sku  = '2016-datacenter' }
...
try {
    Write-au2matorLog -Type INFO -Text "Try to authenticate with Azure REST API"
    ...
    try {
        Write-au2matorLog -Type INFO -Text "Try to build all pre Variables"
        $Location = GET-Location -Name $c_Location -Searchcoloumn LocationDisplay -resultcoloumn LocationName
        $VMsize = $c_VMSize

        $sku = GET-VMImage -Name $c_VMOS -Searchcoloumn NiceName -resultcoloumn SKU
        $publisher = GET-VMImage -Name $c_VMOS -Searchcoloumn NiceName -resultcoloumn publisher
        $version = "latest"
        $offer = GET-VMImage -Name $c_VMOS -Searchcoloumn NiceName -resultcoloumn offer

        $DiskaName="Disk"+$sku+(Get-Random)
        ...
        $VMname = $c_VMName
        $PW = $c_VMPassword
        $RessourceGroupName = $c_RessourceGroup
        



        try {
            Write-au2matorLog -Type INFO -Text "Try to create VM"
...
"@
            ...
            do {
              ...
              {
                  throw $result.properties.provisioningState
              }
            ...
            Write-au2matorLog -Type INFO -Text "VM Creation was successfull"

            $au2matorReturn = "VM Creation was successfull"
            $TeamsReturn = "VM Creation was successfull" #No Special Characters allowed
            $AdditionalHTML = "VM Creation was successfull
            <br>
                "
            $Status = "COMPLETED"
        }
            ...
            Write-au2matorLog -Type ERROR -Text "Error on VM Creation"
            Write-au2matorLog -Type ERROR -Text $Error
        
            $au2matorReturn = "Failed VM Creation, Error: $Error"
            $TeamsReturn = "Failed VM Creation" #No Special Characters allowed
            $AdditionalHTML = "Failed VM Creation
            <br>
            Error: $Error
                "
            $Status = "ERROR"
        ...
        Write-au2matorLog -Type ERROR -Text "Error to build pre Variables"
        Write-au2matorLog -Type ERROR -Text $Error
    
        $au2matorReturn = "Error to build pre Variables, Error: $Error"
        $TeamsReturn = "Error to build pre Variables" #No Special Characters allowed
        $AdditionalHTML = "Error to build pre Variables
        <br>
        Error: $Error
            "
        $Status = "ERROR"
    ...
    Write-au2matorLog -Type ERROR -Text "Failed to authenticate with Azure REST API"
    Write-au2matorLog -Type ERROR -Text $Error

    $au2matorReturn = "Failed to authenticate with Azure REST API, Error: $Error"
    $TeamsReturn = "Failed to authenticate with Azure REST API" #No Special Characters allowed
    $AdditionalHTML = "Failed to authenticate with Azure REST API
    <br>
    Error: $Error
        "
    $Status = "ERROR"
